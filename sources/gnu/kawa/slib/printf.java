    ...
    public class frame11 extends ModuleBody {
        ...
        public Object lambda30formatReal$V(Object signed$Qu, Object sgn, Object digs, Object exp, Object[] argsArray) {
            ...
            if (lists.isNull(rest)) {
                try {
                    String str2 = characters.isChar$Eq(printf.Lit5, (Char) sgn) ? "-" : signed$Qu != Boolean.FALSE ? "+" : this.staticLink.blank != Boolean.FALSE ? MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR : "";
