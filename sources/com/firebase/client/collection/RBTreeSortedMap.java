...
public class RBTreeSortedMap<K, V> extends ImmutableSortedMap<K, V> {
    ...
    private static class Builder<A, B, C> {
        ...
        private Builder(List<A> keys2, Map<B, C> values2, KeyTranslator<A, B> translator) {
            this.keys = keys2;
            this.values = values2;
        ...
        public static <A, B, C> RBTreeSortedMap<A, C> buildFrom(List<A> keys2, Map<B, C> values2, KeyTranslator<A, B> translator, Comparator<A> comparator) {
    ...
    public ImmutableSortedMap<K, V> remove(K key) {
        return !containsKey(key) ? this : new RBTreeSortedMap(this.root.remove(key, this.comparator).copy(null, null, Color.BLACK, null, null), this.comparator);
    }
    ...
    public static <A, B, C> RBTreeSortedMap<A, C> buildFrom(List<A> keys, Map<B, C> values, KeyTranslator<A, B> translator, Comparator<A> comparator2) {
    ...
    public static <A, B> RBTreeSortedMap<A, B> fromMap(Map<A, B> values, Comparator<A> comparator2) {
        return Builder.buildFrom(new ArrayList(values.keySet()), values, com.firebase.client.collection.ImmutableSortedMap.Builder.identityTranslator(), comparator2);
    }
}
