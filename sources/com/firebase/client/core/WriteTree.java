...
public class WriteTree {
    ...
    public boolean removeWrite(long writeId) {
        ...
        while (true) {
            ...
            UserWriteRecord record = (UserWriteRecord) i$.next();
            if (record.getWriteId() == writeId) {
        ...
        if ($assertionsDisabled || writeToRemove != null) {
            ...
            if (writeToRemove.isOverwrite()) {
                ...
                while (i$2.hasNext()) {
                    this.visibleWrites = this.visibleWrites.removeWrite(writeToRemove.getPath().child((Path) ((Entry) i$2.next()).getKey()));
                }
            }
            return true;
        }
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=com.firebase.client.snapshot.Node, code=com.firebase.client.snapshot.Node<com.firebase.client.snapshot.NamedNode>, for r14v0, types: [com.firebase.client.snapshot.Node<com.firebase.client.snapshot.NamedNode>, com.firebase.client.snapshot.Node] */
    public Node calcCompleteEventChildren(Path treePath, Node<NamedNode> completeServerChildren) {
