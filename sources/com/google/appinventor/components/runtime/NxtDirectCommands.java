    ...
    public void MessageWrite(int mailbox, String message) {
        ...
        if (checkBluetooth(functionName)) {
            if (mailbox < 1 || mailbox > 10) {
                this.form.dispatchErrorOccurredEvent(this, functionName, 409, Integer.valueOf(mailbox));
                return;
            }
                ...
                while (i < array.length) {
                    try {
                        ...
                        if (n2 == 0 || n2 == -1) {
                            ...
                            this.form.dispatchErrorOccurredEvent(this, functionName, 413, Integer.valueOf(i + 1));
                            return;
                        }
                    } catch (NumberFormatException e) {
                        this.form.dispatchErrorOccurredEvent(this, functionName, 412, Integer.valueOf(i + 1));
                        return;
                    }
                }
