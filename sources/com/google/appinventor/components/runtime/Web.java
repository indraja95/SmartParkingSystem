...
public class Web extends AndroidNonvisibleComponent implements Component {
    ...
    public void Get() {
        ...
        if (webProps != null) {
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    Web.this.performRequest(webProps, null, null, HttpGet.METHOD_NAME, "Get");
                }
            });
        }
    }
    ...
    public void PostFile(final String path) {
        ...
        if (webProps != null) {
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    Web.this.performRequest(webProps, null, path, HttpPost.METHOD_NAME, "PostFile");
                }
            });
        }
    }
    ...
    public void PutFile(final String path) {
        ...
        if (webProps != null) {
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    Web.this.performRequest(webProps, null, path, HttpPut.METHOD_NAME, "PutFile");
                }
            });
        }
    }
    ...
    public void Delete() {
        ...
        if (webProps != null) {
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    Web.this.performRequest(webProps, null, null, HttpDelete.METHOD_NAME, "Delete");
                }
            });
        }
    }
            ...
            AsynchUtil.runAsynchronously(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        Web.this.performRequest(webProps, requestData, null, str4, str3);
    ...
    private File createFile(String fileName, String responseType) throws IOException, FileException {
