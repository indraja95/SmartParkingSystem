...
public class AppInvHTTPD extends NanoHTTPD {
    ...
    public Response serve(String uri, String method, Properties header, Properties parms, Properties files, Socket mySocket) {
        ...
        if (method.equals(HttpOptions.METHOD_NAME)) {
            ...
            Response response2 = new Response(NanoHTTPD.HTTP_OK, "text/plain", "OK");
            ...
            if (hmacKey != null) {
                try {
                    ...
                    Response response5 = new Response(NanoHTTPD.HTTP_OK, "text/plain", "NOT");
                    return response5;
                }
            } else {
            ...
            if (method.equals(HttpPut.METHOD_NAME)) {
                ...
                if (error.booleanValue()) {
                    Response response8 = new Response(NanoHTTPD.HTTP_INTERNALERROR, "text/plain", "NOTOK");
                ...
                Response response9 = new Response(NanoHTTPD.HTTP_OK, "text/plain", "OK");
