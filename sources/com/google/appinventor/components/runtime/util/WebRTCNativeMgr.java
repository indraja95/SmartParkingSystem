...
public class WebRTCNativeMgr {
    ...
    public WebRTCNativeMgr(String rendezvousServer3, String rendezvousResult) {
        ...
        if (rendezvousResult.isEmpty() || rendezvousResult.startsWith("OK")) {
            rendezvousResult = "{\"rendezvous2\" : \"rendezvous.appinventor.mit.edu\",\"iceservers\" : [{ \"server\" : \"stun:stun.l.google.com:19302\" },{ \"server\" : \"turn:turn.appinventor.mit.edu:3478\",\"username\" : \"oh\",\"password\" : \"boy\"}]}";
        }
        try {
    ...
    public void send(String output) {
        try {
            ...
            this.dataChannel.send(new Buffer(ByteBuffer.wrap(output.getBytes(HTTP.UTF_8)), false));
