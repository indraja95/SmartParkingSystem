        ...
        if (!hashMap.containsKey(namedType)) {
            ...
            if (findSubtypes != null && !findSubtypes.isEmpty()) {
                for (NamedType namedType3 : findSubtypes) {
                    AnnotatedClass constructWithoutSuperTypes = AnnotatedClass.constructWithoutSuperTypes(namedType3.getType(), annotationIntrospector, mapperConfig);
                    if (!namedType3.hasName()) {
                        namedType2 = new NamedType(namedType3.getType(), annotationIntrospector.findTypeName(constructWithoutSuperTypes));
                    } else {
