...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    private static final byte[] FALSE_BYTES = {Opcode.JR_LT32, Opcode.PORT_CNV_OUTPUT, Opcode.JR_EQ8, Opcode.JR_NEQF, Opcode.JR_LT16};
    static final byte[] HEX_CHARS = CharTypes.copyHexBytes();
    private static final int MAX_BYTES_TO_BUFFER = 512;
    private static final byte[] NULL_BYTES = {Opcode.JR_EQ32, 117, Opcode.JR_EQ8, Opcode.JR_EQ8};
    protected static final int SURR1_FIRST = 55296;
    protected static final int SURR1_LAST = 56319;
    protected static final int SURR2_FIRST = 56320;
    protected static final int SURR2_LAST = 57343;
    private static final byte[] TRUE_BYTES = {Opcode.JR_LTEQ8, Opcode.JR_NEQ32, 117, Opcode.JR_LT16};
    ...
    public void _writeBinary(Base64Variant base64Variant, byte[] bArr, int i, int i2) throws IOException, JsonGenerationException {
        ...
        while (i <= i3) {
            ...
            int i7 = i5 + 1;
            i = i7 + 1;
            this._outputTail = base64Variant.encodeBase64Chunk((int) (((bArr[i5] & Opcode.TST) | i6) << 8) | (bArr[i7] & Opcode.TST), this._outputBuffer, this._outputTail);
            maxLineLength--;
            if (maxLineLength <= 0) {
                byte[] bArr2 = this._outputBuffer;
    ...
    public int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        while (i7 > 2) {
            ...
            i3 = i10 + 1;
            i7 -= 3;
            this._outputTail = base64Variant.encodeBase64Chunk((int) (((bArr[i8] & Opcode.TST) | i9) << 8) | (bArr[i10] & Opcode.TST), this._outputBuffer, this._outputTail);
