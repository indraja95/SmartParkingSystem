...
public final class ByteSourceJsonBootstrapper {
    ...
    public JsonEncoding detectEncoding() throws IOException, JsonParseException {
        ...
        boolean z = true;
        if (ensureLoaded(4)) {
            byte b = (this._inputBuffer[this._inputPtr] << 24) | ((this._inputBuffer[this._inputPtr + 1] & Opcode.TST) << 16) | ((this._inputBuffer[this._inputPtr + 2] & Opcode.TST) << 8) | (this._inputBuffer[this._inputPtr + 3] & Opcode.TST);
            if (!handleBOM(b)) {
                if (!checkUTF32(b)) {
                }
            }
    ...
    public Reader constructReader() throws IOException {
        ...
        switch (encoding) {
            ...
            case UTF8:
                ...
                InputStream inputStream2 = inputStream == null ? new ByteArrayInputStream(this._inputBuffer, this._inputPtr, this._inputEnd) : this._inputPtr < this._inputEnd ? new MergedStream(this._context, inputStream, this._inputBuffer, this._inputPtr, this._inputEnd) : inputStream;
