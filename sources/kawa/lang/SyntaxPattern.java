...
public class SyntaxPattern extends Pattern implements Externalizable {
    ...
    public void disassemble(PrintWriter ps, Translator tr, int start, int limit) {
        ...
        while (i < limit) {
            ...
            ps.print(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + i + ": " + ch);
            i++;
            int opcode = ch & 7;
            value = (value << 13) | (ch >> 3);
            switch (opcode) {
                ...
                case 5:
                    ...
                    int i2 = i + value;
                    int i3 = i2 + 1;
                    ps.println(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + i2 + ": - repeat first var:" + (this.program.charAt(i2) >> 3));
                    i = i3 + 1;
                    ps.println(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + i3 + ": - repeast nested vars:" + (this.program.charAt(i3) >> 3));
                    break;
                case 6:
